...
class MainActivity : AppCompatActivity() {
    ...
    private fun applySelectedColor(selectedColor: Int) {
        content.setBackgroundColor(ColorUtils.blendARGB(selectedColor, Color.BLACK, 0.3f))
        window.statusBarColor = ColorUtils.blendARGB(selectedColor, Color.BLACK, 0.1f)
